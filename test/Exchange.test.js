import {tokens, ether, EVM_Revert, ETHER_ADDRESS} from './helpers' // we can only use this import function feature as we required babel in the truffle config file
...
contract('Exchange', ([deployer, feeAccount, user1, user2]) => { // can change accounts to [deployer]
	let token
	let exchange 
	const feePercent = 10
	...
	describe('deployment', () => {
		it('tracks the fee account', async() => { // in a function that uses an 'await' call, need to include 'async()' in the function header
			const result = await exchange.feeAccount()
			result.should.equal(feeAccount)
		})

		it('tracks the fee percent', async() => { // in a function that uses an 'await' call, need to include 'async()' in the function header
	...
	describe('order actions', async() => {
		...
		describe('filling orders', async() => {
			...
			describe('success', async() => {
				...
				it('executes the trades & charges fees', async() => {
					let balance
