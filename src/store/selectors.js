...
const account = state => get(state, 'web3.account') // this get function will return a default undefined value if it doesn't exist, which won't crash our code
...
const filledOrders = state => get(state, 'exchange.filledOrders.data', []) // empty array [] as default value
...
const decorateMyFilledOrder = (order, account) => {
    const myOrder = order.user === account // check if user made or filled the order
