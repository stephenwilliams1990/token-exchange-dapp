...
module.exports = async function(callback) {
	try {
		// Fetch accounts from the wallet - these are unlocked		
		...
		// Wait 1 second - this is to ensure the timestamps are different between orders 
		await wait(1)
		...
		for (let i = 1; i <= 10; i++) {
			...
			console.log(`Made an order from ${user2}`)
			await wait(1)
		}
	} 
	 catch(error) {
